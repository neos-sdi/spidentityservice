...
INSERT INTO [dbo].[AssemblyConfiguration] ([AssemblyFulldescription], [AssemblyTypeDescription], [TraceResolve], [Selected])
VALUES ('SharePoint.IdentityService.ActiveDirectory, Version=1.0.0.1, Culture=neutral, PublicKeyToken=ad9787278992c174','SharePoint.IdentityService.ActiveDirectory.ActiveDirectoryWrapper', 1, 1)
GO
...
[Secure] [bit] NULL,
[MaxRows] [int] NULL,
[ConnectString] [nvarchar](1024) NULL,
...
VALUES ('default','domain\user', 'password', 60, 1, 200)
GO
