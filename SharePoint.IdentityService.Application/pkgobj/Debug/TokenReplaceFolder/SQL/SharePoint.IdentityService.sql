...
VALUES ('SharePoint.IdentityService.ActiveDirectory, Version=15.0.0.0, Culture=neutral, PublicKeyToken=5f2cd3262c7b6db4','SharePoint.IdentityService.ActiveDirectory.ActiveDirectoryWrapper', 1, 1, 0)
GO

INSERT INTO [dbo].[AssemblyConfiguration] ([AssemblyFulldescription], [AssemblyTypeDescription], [TraceResolve], [Selected], [ClaimsExt]) 
VALUES ('SharePoint.IdentityService.Application, Version=15.0.0.0, Culture=neutral, PublicKeyToken=5f2cd3262c7b6db4','SharePoint.IdentityService.ClaimsAugmenter', 1, 1, 1)
GO
...
VALUES ('default','yourdomain\youruser', 'password', 60, 1, 200)
GO
...
CONSTRAINT [PK_DomainConfiguration] PRIMARY KEY CLUSTERED ([DnsName])
)
